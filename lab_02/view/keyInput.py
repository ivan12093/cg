...
class ShiftFrame:
    def __init__(self, root, width, height, canva, color=Settings.COLOR_MAIN_BG, rootFunc=None):
        ...
        self.headLabel = Label(self.f, text='-------  Сдвинуть  -------', bg=Settings.COLOR_MAIN_BG,
                               fg=Settings.COLOR_BTN, font=('Arial', 12, 'bold'))
        ...
        self.btn = WrapButton(self.f, txt='Применить', padx=10, pady=3, command=lambda: self.shift(), font=('Arial', 10, 'bold'))
...
class ScaleFrameSecondVersion:
    def __init__(self, root, width, height, canva, color=Settings.COLOR_MAIN_BG, rootFunc=None):
        ...
        self.headLabel = Label(self.f, text='-------  Масштабировать  -------', bg=Settings.COLOR_MAIN_BG,
                               fg=Settings.COLOR_BTN, font=('Arial', 12, 'bold'))
